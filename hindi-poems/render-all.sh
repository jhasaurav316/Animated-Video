...
#
# Usage:
#   bash hindi-poems/render-all.sh              # Render all
#   bash hindi-poems/render-all.sh --batch 1    # Day 1: rhymes 1-50
#   bash hindi-poems/render-all.sh --batch 2    # Day 2: rhymes 51-100
#   bash hindi-poems/render-all.sh --batch 3    # Day 3: rhymes 101-150
# ============================================================================
...
CATALOG="$PROJECT_DIR/hindi-poems/catalog.json"
OUT_YT="$PROJECT_DIR/out/hindi-youtube"
OUT_SHORTS="$PROJECT_DIR/out/hindi-shorts"
LOG_FILE="$PROJECT_DIR/hindi-poems/render-log.txt"
...
# ---------- Setup ----------
echo "============================================"
echo "  Bulk Hindi Video Renderer"
echo "============================================"
echo ""
...
# Initialize log
echo "============================================" > "$LOG_FILE"
echo "  Hindi Render Log - Started at $(timestamp)" >> "$LOG_FILE"
echo "============================================" >> "$LOG_FILE"
...
log "Found $TOTAL Hindi rhymes to render"
...
# Convert rhymeId to PascalCase composition ID with Hindi prefix (must match register-compositions.js)
to_pascal_case() {
...
for RHYME_ID in $RHYME_IDS; do
  ...
  COMP_ID="Hindi$(to_pascal_case "$RHYME_ID")"
