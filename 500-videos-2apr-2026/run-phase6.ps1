# ============================================================================
# Phase 6 - 50 Videos (20 Desserts + 25 Gems & Minerals + 5 Dance Forms)
# ============================================================================
# Batch: 500-videos-2apr-2026
# Usage: cd C:\test\500-videos-2apr-2026 && .\run-phase6.ps1
# ============================================================================
...
Write-Host "  PHASE 6: 20 Desserts + 25 Gems & Minerals + 5 Dance Forms" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "desserts\catalog.json"; Name = "Desserts"; From = 10; To = 30 },
    @{ Path = "gems-minerals\catalog.json"; Name = "Gems & Minerals"; From = 0; To = 25 },
    @{ Path = "dance-forms\catalog.json"; Name = "Dance Forms"; From = 0; To = 5 }
)
...
node (Join-Path $ProjectDir "desserts\register-compositions.js")
node (Join-Path $ProjectDir "gems-minerals\register-compositions.js")
node (Join-Path $ProjectDir "dance-forms\register-compositions.js")
