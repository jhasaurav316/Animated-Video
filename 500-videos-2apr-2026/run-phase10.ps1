# ============================================================================
# Phase 10 - 50 Videos (15 Mythical Creatures + 20 Weather & Nature + 15 World Flags)
# ============================================================================
# Batch: 500-videos-2apr-2026
# Usage: cd C:\test\500-videos-2apr-2026 && .\run-phase10.ps1
# ============================================================================
...
Write-Host "  PHASE 10: 15 Mythical Creatures + 20 Weather & Nature + 15 World Flags" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "mythical-creatures\catalog.json"; Name = "Mythical Creatures"; From = 5; To = 20 },
    @{ Path = "weather-nature\catalog.json"; Name = "Weather & Nature"; From = 0; To = 20 },
    @{ Path = "world-flags\catalog.json"; Name = "World Flags"; From = 0; To = 15 }
)
...
node (Join-Path $ProjectDir "weather-nature\register-compositions.js")
node (Join-Path $ProjectDir "world-flags\register-compositions.js")
