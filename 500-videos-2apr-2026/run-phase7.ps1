# ============================================================================
# Phase 7 - 50 Videos (20 Dance Forms + 25 Reptiles + 5 Farm Animals)
# ============================================================================
# Batch: 500-videos-2apr-2026
# Usage: cd C:\test\500-videos-2apr-2026 && .\run-phase7.ps1
# ============================================================================
...
Write-Host "  PHASE 7: 20 Dance Forms + 25 Reptiles + 5 Farm Animals" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "dance-forms\catalog.json"; Name = "Dance Forms"; From = 5; To = 25 },
    @{ Path = "reptiles\catalog.json"; Name = "Reptiles"; From = 0; To = 25 },
    @{ Path = "farm-animals\catalog.json"; Name = "Farm Animals"; From = 0; To = 5 }
)
