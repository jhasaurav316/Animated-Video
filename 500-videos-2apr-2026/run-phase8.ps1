# ============================================================================
# Phase 8 - 50 Videos (20 Farm Animals + 25 Kitchen Items + 5 Ocean Life)
# ============================================================================
# Batch: 500-videos-2apr-2026
# Usage: cd C:\test\500-videos-2apr-2026 && .\run-phase8.ps1
# ============================================================================
...
Write-Host "  PHASE 8: 20 Farm Animals + 25 Kitchen Items + 5 Ocean Life" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "farm-animals\catalog.json"; Name = "Farm Animals"; From = 5; To = 25 },
    @{ Path = "kitchen-items\catalog.json"; Name = "Kitchen Items"; From = 0; To = 25 },
    @{ Path = "ocean-life\catalog.json"; Name = "Ocean Life"; From = 0; To = 5 }
)
...
node (Join-Path $ProjectDir "kitchen-items\register-compositions.js")
