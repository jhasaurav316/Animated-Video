# ============================================================================
# Phase 4 - 50 Videos (30 Emotions + 20 Tools)
# ============================================================================
# Batch: 500-videos-2apr-2026
# Usage: cd C:\test\500-videos-2apr-2026 && .\run-phase4.ps1
# ============================================================================
...
Write-Host "  PHASE 4: 30 Emotions + 20 Tools" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "emotions\catalog.json"; Name = "Emotions"; From = 0; To = 30 },
    @{ Path = "tools\catalog.json"; Name = "Tools"; From = 0; To = 20 }
)
...
node (Join-Path $ProjectDir "emotions\register-compositions.js")
