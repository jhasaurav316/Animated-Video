# ============================================================================
# Phase 1 - 50 Videos (30 Body Parts + 20 Professions)
# ============================================================================
# Batch: 500-videos-2apr-2026
# Usage: cd C:\test\500-videos-2apr-2026 && .\run-phase1.ps1
# ============================================================================
...
Write-Host "  PHASE 1: 30 Body Parts + 20 Professions" -ForegroundColor Cyan
...
$catalogs = @(
    ...
    @{ Path = "professions\catalog.json"; Name = "Professions"; From = 0; To = 20 }
)
