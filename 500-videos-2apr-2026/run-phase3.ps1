# ============================================================================
# Phase 3 - 50 Videos (20 Dog Breeds + 30 Trees & Plants)
# ============================================================================
# Batch: 500-videos-2apr-2026
# Usage: cd C:\test\500-videos-2apr-2026 && .\run-phase3.ps1
# ============================================================================
...
Write-Host "  PHASE 3: 20 Dog Breeds + 30 Trees & Plants" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "dog-breeds\catalog.json"; Name = "Dog Breeds"; From = 10; To = 30 },
    @{ Path = "trees-plants\catalog.json"; Name = "Trees & Plants"; From = 0; To = 30 }
)
...
node (Join-Path $ProjectDir "trees-plants\register-compositions.js")
