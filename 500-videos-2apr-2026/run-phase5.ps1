# ============================================================================
# Phase 5 - 50 Videos (10 Tools + 30 Clothing + 10 Desserts)
# ============================================================================
# Batch: 500-videos-2apr-2026
# Usage: cd C:\test\500-videos-2apr-2026 && .\run-phase5.ps1
# ============================================================================
...
Write-Host "  PHASE 5: 10 Tools + 30 Clothing + 10 Desserts" -ForegroundColor Cyan
...
$catalogs = @(
    @{ Path = "tools\catalog.json"; Name = "Tools"; From = 20; To = 30 },
    @{ Path = "clothing\catalog.json"; Name = "Clothing"; From = 0; To = 30 },
    @{ Path = "desserts\catalog.json"; Name = "Desserts"; From = 0; To = 10 }
)
...
node (Join-Path $ProjectDir "tools\register-compositions.js")
node (Join-Path $ProjectDir "clothing\register-compositions.js")
