#!/usr/bin/env node
// ============================================================================
// Auto-Register All ABC Alphabet Compositions in AbcAlphabetRoot.tsx
// ============================================================================
// Reads abc-alphabets/catalog.json and generates a new AbcAlphabetRoot.tsx that
// registers every video as a portrait (1080x1920) Remotion composition.
//
// Usage:
//   node abc-alphabets/register-compositions.js
// ============================================================================
...
const CATALOG_PATH = path.join(PROJECT_ROOT, "abc-alphabets", "catalog.json");
const ROOT_TSX_PATH = path.join(PROJECT_ROOT, "src", "AbcAlphabetRoot.tsx");
const BACKUP_PATH = path.join(PROJECT_ROOT, "src", "AbcAlphabetRoot.tsx.backup");

const FPS = 30;

// ---------- Helpers ----------

// Convert an id like "alphabet-rainbow" to PascalCase "AlphabetRainbow"
...
function main() {
  console.log("============================================");
  console.log("  Register All ABC Alphabets in AbcAlphabetRoot.tsx");
  console.log("============================================\n");
  ...
  // Back up existing AbcAlphabetRoot.tsx
  if (fs.existsSync(ROOT_TSX_PATH)) {
    fs.copyFileSync(ROOT_TSX_PATH, BACKUP_PATH);
    console.log(`Backed up existing AbcAlphabetRoot.tsx to AbcAlphabetRoot.tsx.backup`);
  }

  // ---------- Generate AbcAlphabetRoot.tsx content ----------
  let content = "";
  ...
  content += `export const AbcAlphabetRemotionRoot: React.FC = () => {\n`;
  content += `  return (\n`;
  content += `    <>\n`;
  ...
  for (const video of videos) {
    ...
    const compId = "Abc" + toPascalCase(videoId);
  ...
  console.log(`\nAbcAlphabetRoot.tsx generated successfully!`);
